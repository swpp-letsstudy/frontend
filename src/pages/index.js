...
export { default as ChattingPage } from 'pages/ChattingPage'

export { default as CloudStoragePage } from 'pages/CloudStoragePage'
...
export { default as MyPolicyListPage } from 'pages/Group/MyPolicyListPage'
export { default as PolicyListPage } from 'pages/Group/PolicyListPage'
export { default as PolicyDetailPage } from 'pages/Group/PolicyDetailPage'
export { default as PolicyFormPage } from 'pages/Group/PolicyFormPage'
export { default as MyMeetingFineListPage } from 'pages/Meeting/MyMeetingFineListPage'
export { default as MeetingPolicyManagePage } from 'pages/Meeting/MeetingPolicyManagePage'
